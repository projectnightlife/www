...
function subscription()
{
	...
	{
		api.launchDialog("Subscription", "<p>We'll now ensure you're always right up to date with this blog.</p><p>Whenever they publishes a new piece of content, we'll send you a  notification to let you know.</p>");
