...
<body id="blogs{if $ismobile == "true"} mobile{/if}">
  <div class="wrapper">
    ...
    <div style="height: 270px; width: 100%; border-bottom: 1px solid #111; position: relative; background: #131313; background-image: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#151515), to(#0b0b0b)); margin-top: 10px; margin-bottom: 5px;">
