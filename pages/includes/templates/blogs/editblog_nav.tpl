<div class="vnav">
  <a href="pages/blogs/editblog.php?v=home">Dashboard</a>
  <a href="pages/blogs/editblog.php?v=new">New post</a>
  <a href="pages/blogs/editblog.php?v=manage">Manage posts</a>
