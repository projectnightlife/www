...
if (AC_FL_RunContent == 0 || DetectFlashVer == 0) {
	...
	if(hasRightVersion) { 
		AC_FL_RunContent(
			...
			'movie', 'charts',
			'src', 'charts',
			'FlashVars', 'library_path=charts_library&xml_source=http://www.projectnightlife.co.uk/stats/blogs/{$pageData["blogIdHash"]}_month_posts_served.xml', 
		...
		AC_FL_RunContent(
			...
			'movie', 'charts',
			'src', 'charts',
			'FlashVars', 'library_path=charts_library&xml_source=http://www.projectnightlife.co.uk/stats/blogs/{$pageData["blogIdHash"]}_month_comments.xml', 
			'id', 'month_comments',
			'name', 'month_comments',
			'menu', 'true',
			'allowFullScreen', 'true',
		...
		AC_FL_RunContent(
			...
			'movie', 'charts',
			'src', 'charts',
			'FlashVars', 'library_path=charts_library&xml_source=http://www.projectnightlife.co.uk/stats/blogs/{$pageData["blogIdHash"]}_month_subscribers.xml', 
		...
		AC_FL_RunContent(
			...
			'movie', 'charts',
			'src', 'charts',
			'FlashVars', 'library_path=charts_library&xml_source=http://www.projectnightlife.co.uk/stats/blogs/{$pageData["blogIdHash"]}_month_posts.xml', 
			'id', 'month_posts',
			'name', 'month_posts',
			'menu', 'true',
			'allowFullScreen', 'true',
