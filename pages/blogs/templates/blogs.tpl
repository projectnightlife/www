      ...
      <div class="canvas">
        ...
        <div class="span650 topspcr15">
          <div class="UIpanel">
            ...
            <ul id="posts" class="UIobjectlist listw630">
              {if $posts|@count == 0}
                <div style="text-align: center; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size: 16px; padding: 15px 0;">No posts in this style yet</div>
              {/if}
        ...
        <div class="span300 leftspcr topspcr15">
          <div class="UIpanel">
            ...
            {if $blogs|@count == 0}
                <div style="text-align: center; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size: 16px; padding: 15px 0;">No blogs in this style yet</div>
              {/if}
