            ...
            <table class="socialPlugins">
              <tbody>
                <tr>
                  ...
                  <th><iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.projectnightlife.co.uk%2Fpost%2F{$post->id}&amp;layout=button_count&amp;show_faces=false&amp;width=95&amp;action=recommend&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:95px; height:21px; display: block;" allowTransparency="true"></iframe></th>
                </tr>
              </tbody>
            </table>
          </div>
